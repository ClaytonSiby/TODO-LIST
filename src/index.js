import {saveAndRender, render, lists, selectedListId, listsContainer, tasksContainer} from './modules/saveandrender';
import {newTaskForm, newTaskInput, newTaskDate, newTaskDescription, newTaskPriority} from './modules/Logic';
